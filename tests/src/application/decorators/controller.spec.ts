import { Controller, Delete, Get, Middleware, Post, Put } from '@/application/decorators';
import { MiddlewareHandler, Middlewares } from '@/application/decorators/controller';
